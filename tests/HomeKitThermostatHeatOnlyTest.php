...
class HomeKitThermostatHeatOnlyTest extends HomeKitBaseTest
{
    public function testAccessory(): void
    {
        ...
        IPS_SetProperty($bridgeID, 'AccessoryThermostatHeatOnly', json_encode([
            [
                'ID'                   => 2,
                'Name'                 => 'Test',
        ...
        $accessory = json_decode(file_get_contents(__DIR__ . '/exports/ThermostatHeatOnly.json'), true);
